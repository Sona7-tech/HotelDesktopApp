 ...
 * @author Lenovo
 */
public class NewExpenseFrame extends javax.swing.JFrame {

    private ExpenseDao expenseDao;
    private EmployeeDao employeeDao;
    private  MainFrame aThis;
    public NewExpenseFrame() {
        initComponents();
    }

    NewExpenseFrame(ExpenseDao expenseDao, EmployeeDao employeeDao, MainFrame aThis) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
      ...
      JOptionPane.showMessageDialog(null,"Expense has been successfully created!");
      
      } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null,"Problem! Expense has not been successfully created!", "Error!", JOptionPane.ERROR_MESSAGE);
        }
         this.dispose();

...
public class EditClientFrame extends javax.swing.JFrame {
    ...
    EditClientFrame(ClientDao clientDao, Long selectedId, MainFrame aThis) {
       initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(UpdateBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
    ...
    private void UpdateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateBtnActionPerformed
        try{
            ...
            Client client = clientDao.getClientById(selectedId);
            client.setName(name);
            ...
            JOptionPane.showMessageDialog(null, "Client has been successfully updated");
            
        }catch(Exception ex){
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Client has not been successfully updated!", "Error",JOptionPane.ERROR_MESSAGE);
        }
        this.dispose();
        try {
            aThis.showClientData(clientDao.getClientList());
        } catch (Exception ex) {
           ex.printStackTrace();
        }
    ...
    private void showClientOldData() {
        
        try {
           Client client =  clientDao.getClientById(selectedId);
           nameTxt.setText(client.getName());
           surnameTxt.setText(client.getSurname());
           genderTxt.setSelectedItem(client.getGender());
           contactTxt.setText(client.getPhone());
           nationTxt.setText(client.getNationality());
        } catch (Exception ex) {

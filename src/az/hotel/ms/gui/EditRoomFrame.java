...
private MainFrame aThis;    
    ...
    EditRoomFrame(RoomDao roomDao, RoomTypeDao roomTypeDao, StatusDao statusDao, CleaningDao cleaningDao, Long selectedId, MainFrame aThis) {
        try {
        initComponents();
        ...
        this.aThis = aThis;
        Room room = roomDao.getRoomById(selectedId);
        roomTxt.setText(room.getRoomNumber());
        System.out.println("2 "+room.getRoomNumber());
        editRoomTypeCombo(room.getRoomType());
        editStatusCombo(room.getStatus());
        costTxt.setText(String.valueOf(room.getCost()));
        editCleaningCombo(room.getCleaning());
    } catch (Exception ex) {
        ex.printStackTrace();
    }
    }
    ...
    private void initComponents() {
        ...
        updateCmb = new javax.swing.JButton();
        ...
        updateCmb.setText("Update");
        updateCmb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateCmbActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(updateCmb, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(172, 172, 172)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(updateCmb, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
 ...
 private void editCleaningCombo(Cleaning c) {
        ...
        try {
            ...
            cleaningCombo.setSelectedItem(c);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
 }
         private void editStatusCombo(Status s) {
        ...
        try {
            ...
            statusCombo.setSelectedItem(s);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        
         }
         private void editRoomTypeCombo(RoomType r) {
        ...
        try {
            ...
            roomTypeCombo.setSelectedItem(r);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        
         }
    private void updateCmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateCmbActionPerformed
        try{
            ...
            JOptionPane.showMessageDialog(null,"Room has been successfully updated!");
            
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null,"Problem! Room has not been successfully updated!", "Error!", JOptionPane.ERROR_MESSAGE);
        }
        this.dispose();
    try {
    ...
    }//GEN-LAST:event_updateCmbActionPerformed
    ...
    private javax.swing.JButton updateCmb;
